...
cap=cv2.VideoCapture(r"D:\Imam\Belajar\Python\Computer_Vision\Car_Counting\Car.mp4")
...
area1 = [(540, 545), (510, 535), (390, 560), (410, 575)]
area2 = [(155, 510), (140, 530), (310, 530), (295, 510)]

# Initialize video writer for the processed video
result_video_path = r'D:\Imam\Belajar\Python\Computer_Vision\Car_Counting\result.mp4'  # Modify the path and filename as needed
fps = 30  # Modify if the frame rate is different
w, h = 540, 960  # Modify with the desired width and height
...
while True:
    ...
    cv2.putText(frame, str(a), (549, 465), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,0), 2)
    cv2.putText(frame, str(b), (926, 465), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 0), 2)
    cv2.putText(frame, f'Count = {str(count_car1)}', (50, 80), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 0), 2)
